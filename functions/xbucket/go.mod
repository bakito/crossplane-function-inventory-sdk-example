module ghcr.io/bakito/crossplane-function-inventory-sdk-example/xbucket
...
replace dev.crossplane.io/models => ../../schemas/go

tool github.com/bakito/crossplane-function-inventory-sdk/cmd/tag-const-gen
